# =============================================================================
# Terraform — Snowflake Data Platform Infrastructure (STAGING)
#
# Staging environment: Pre-production validation with production-like config.
...
terraform {
  ...
  backend "s3" {
    ...
    key            = "data-vault-platform/staging/terraform.tfstate"
    region         = "us-east-1"
    encrypt        = true
