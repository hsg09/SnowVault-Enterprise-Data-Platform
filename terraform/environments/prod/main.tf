# =============================================================================
# Terraform — Snowflake Data Platform Infrastructure (PRODUCTION)
#
# Production environment: Multi-region deployment (5-7 Snowflake accounts).
...
terraform {
  ...
  backend "s3" {
    ...
    key            = "data-vault-platform/prod/terraform.tfstate"
    region         = "us-east-1"
    encrypt        = true
